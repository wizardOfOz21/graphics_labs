/*
A2) учет ослабления интенсивности света с расстоянием от источника;
Б1) моделирование равноускоренного падения (с заданной начальной скоростью) при условии абсолютно
упругого соударения с горизонтальной поверхностью;
...
void load_texture()
{
    ...
    unsigned char *data = stbi_load("images/01.png", &width, &height, &cnt, 0);
...
int main(int argc, char *argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glPushMatrix();
            ...
            сreate_prism(4, qprism, 0.3, -0.7, 0.2);
